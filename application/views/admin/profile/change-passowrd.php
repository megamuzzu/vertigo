                           ...
                           <div class="row">
                              <div class="col-sm-4">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="password" class="form-control form-control-sm" id="password" placeholder="Password" name="password" value="" required=""> </div>
                                 </div>
                              </div>
                              <div class="col-sm-4">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="password" class="form-control form-control-sm" id="new_password" placeholder="New Password" name="new_password" value="" required=""> </div>
                                 </div>
                              </div>
                              <div class="col-sm-4">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="password" class="form-control form-control-sm" id="confirm_password" placeholder="Confirm Password" name="confirm_password" value="" required=""> </div>
                                 </div>
                              </div>
                           </div>
                        </div>
