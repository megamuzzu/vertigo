                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Dashboard</h4> </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted mb-4">Hi I'm
                                ...
                                <div class="table-responsive">
                                    <table class="table table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <th scope="row"><strong><i class="fa fa-key"></i> Logged in</strong> </th>
                                                <td>
                                                    <?php echo $admin->title;?>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo wordwrap($admin->address,50,"<br>\n");?>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <?php echo date('d M Y',strtotime($admin->date_join));?>
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionEnquiryRequred))?base_url().'admin/customer/addnew':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle1 bg-primary mb-2"> <i class="bx bx-phone-call text-white display-2"></i> </div>
                                                        <h6>Inquiry</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionConsultantsRequred))?base_url().'admin/consultants':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle2 bg-success"> <i class="bx bxs-user-voice text-white display-2"></i> </div>
                                                        <h6>Consultation</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionKDocRequred))?base_url().'admin/kdocuments':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle3 bg-warning"> <i class="bx bxs-file-doc text-white display-2"></i> </div>
                                                        <h6>K Document</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionSalesRequred))?base_url().'admin/sales':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle1 bg-primary mb-2"> <i class="bx bx-cart text-white display-2"></i> </div>
                                                        <h6>Sales</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionBookingRequred))?base_url().'admin/bookings':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle3 bg-success mb-2"> <i class="bx bx-book-bookmark text-white display-2"></i> </div>
                                                        <h6>Booking</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionKDocRequred))?base_url().'admin/kdocuments':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle2 bg-warning"> <i class="bx bxs-file-doc text-white display-2"></i> </div>
                                                        <h6>K Document</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionProdcutRequred))?base_url().'admin/product':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon rounded-circle1 bg-primary mb-2"> <i class="bx bxl-product-hunt text-white display-2"></i> </div>
                                                        <h6>Product</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionSalesRequred))?base_url().'admin/sales':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle2 bg-primary mb-2"> <i class="bx bxs-cart text-white display-2"></i> </div>
                                                        <h6>Sales</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionFarmerRequred))?base_url().'admin/farmers':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle3 bg-primary mb-2"> <i class="bx bx-group text-white display-2"></i> </div>
                                                        <h6>Farmer</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionAgentRequred))?base_url().'admin/agents':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon rounded-circle1 bg-primary mb-2"> <i class="bx bxs-user-rectangle text-white display-2"></i> </div>
                                                        <h6>Agents</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionCountryRequred))?base_url().'admin/country':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle2 bg-primary mb-2"> <i class="bx bx-flag text-white display-2"></i> </div>
                                                        <h6>Country</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionStateRequred))?base_url().'admin/state':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle3 bg-primary mb-2"> <i class="bx bx-grid-vertical text-white display-2"></i> </div>
                                                        <h6>State</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionDistrictRequred))?base_url().'admin/district':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle4 bg-primary mb-2"> <i class="bx bx-grid-horizontal text-white display-2"></i> </div>
                                                        <h6>District</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionCityRequred))?base_url().'admin/city':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle5 bg-primary mb-2"> <i class="bx bx-dialpad  text-white display-2"></i> </div>
                                                        <h6>Tehsil</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionCompanyRequred))?base_url().'admin/company':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle6 bg-primary mb-2"> <i class="bx bxs-bank text-white display-2"></i> </div>
                                                        <h6>Company</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionHarvestRequred))?base_url().'admin/harvesting_management':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon rounded-circle1 bg-primary mb-2"> <i class="bx bxs-user-rectangle text-white display-2"></i> </div>
                                                        <h6>Harvesting Management</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionDeliveryRequred))?base_url().'admin/delivery_management':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle3 bg-primary mb-2"> <i class="bx bx-flag text-white display-2"></i> </div>
                                                        <h6>Delivery Management</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <a href="<?php echo (!empty($actionPremCustRequred))?base_url().'admin/farmers?is_premium=1':'javascript:void();'?>">
                                                <div class="my-card-body">
                                                    <div class="text-center">
                                                        <div class="mini-stat-icon  rounded-circle2 bg-primary mb-2"> <i class="bx bx-grid-vertical text-white display-2"></i> </div>
                                                        <h6>Premium Customer</h6> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
