         ...
         <div class="col-xl-6">
            ...
            <div class="row">
               ...
               <?php  
                  ...
                  {
                  ?>
               <a class="dropdown-item" href="<?php echo base_url()?>admin/customer/assign/<?php echo $customer['id']; ?>" data-userid="<?php echo $customer['id']; ?>">Edit</a>
               <?php  
                  }
...
<div class="modal fade edit-modal show" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-modal="true" role="dialog" >
    ...
    $(".edit-modal").modal('show');
       var userId = id,
          ...
          data : {} 
           ...
           $("#customer_name_edit").val(response.name);
