                  ...
                  <form action="<?php echo base_url() ?>admin/farmers/insertnow" method="post" role="form" enctype="multipart/form-data">
                           ...
                           <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       if(!empty($farmertypes))
                                       {
                                           foreach ($farmertypes as $farmertype) {
                                               ?>
                                             <option value="<?php echo $farmertype->id;?>" <?php if(set_value( 'farmer_type')==$farmertype->id){echo 'selected';} ?> >
                                                <?php echo $farmertype->title;?>
                                             </option>
                                             <?php
                                       }
                                       }
                              ...
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Farmers Name*" value="<?php echo set_value('name'); ?>" required /> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" maxlength="12" class="form-control form-control-sm" id="mobile" name="mobile" placeholder="Customer Mobile*" value="<?php echo set_value('mobile'); ?>" required /> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control form-control-sm" id="alt_mobile" placeholder="ALT Mobile" name="alt_mobile" value="<?php echo set_value('alt_mobile'); ?>"> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control form-control-sm" id="father_name" placeholder="Father Name" name="father_name" value="<?php echo set_value('father_name'); ?>"> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       if(!empty($states))
                                       {
                                           foreach ($states as $state) {
                                               ?>
                                             <option value="<?php echo $state->id;?>" <?php if(set_value( 'state')==$state->id){echo 'selected';}?> >
                                                <?php echo $state->name;?>
                                             </option>
                                             <?php
                                       }
                              ...
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control form-control-sm" id="pincode" placeholder="Pincode" name="pincode" value="<?php echo set_value('pincode'); ?>"> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <textarea class="form-control form-control-sm" id="village" placeholder="Village" name="village">
                                          <?php echo set_value('village'); ?>
                                       </textarea>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       if(!empty($lead_sources))
                                       {
                                           foreach ($lead_sources as $lead_source) {
                                               ?>
                                             <option value="<?php echo $lead_source->slug;?>" <?php if(set_value( 'source')==$lead_source->slug){echo 'selected';} ?> >
                                                <?php echo $lead_source->title;?>
                                             </option>
                                             <?php
                                       }
                                       }
                              ...
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control form-control-sm" id="whatsapp" placeholder="WhatsApp" name="whatsapp" value="<?php echo set_value('whatsapp'); ?>"> </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                     ...
                     <div class="card-footer">
                        <div class="av-footer">
                           ...
                           <input type="reset" class="btn btn-default btn-sm" value="Reset" /> </div>
                     </div>
               </div>
               </form>
            </div>
...
<?php
   ...
   $(document).ready(function() {
      stateChange('<?php echo @set_value('
         state ');?>', '<?php echo @set_value('
         district ');?>');
      districtChange('<?php echo @set_value('
         district ');?>', '<?php echo @set_value('
         city ');?>');
   });
   </script>
   <?php
